...
image_folder = 'D:\pak aviv\pengolahan citra\pertemuan 10\New folder\Training\mature';
...
image_folder = 'D:\pak aviv\pengolahan citra\pertemuan 10\New folder\Training\half-mature';
filenames = dir(fullfile(image_folder, '*.jpg'));
total_images = numel(filenames);
...
image_folder = 'D:\pak aviv\pengolahan citra\pertemuan 10\New folder\Training\immature';
filenames = dir(fullfile(image_folder, '*.jpg'));
total_images = numel(filenames);
